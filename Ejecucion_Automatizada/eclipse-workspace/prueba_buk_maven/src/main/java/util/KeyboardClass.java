...
public class KeyboardClass { // http://stackoverflow.com/a/1248709/4330555

	private static Robot robot;

	public KeyboardClass() throws AWTException {
		KeyboardClass.robot = new Robot();
	}

	public KeyboardClass(Robot robot) {
		KeyboardClass.robot = robot;
	}

	public void type(String valores) {
		CharSequence characters = valores;
	...
	public static void KeyPressTecl(String tecla) {
		...
		try {
			...
			default:
				throw new IllegalArgumentException("Cannot type character " + tecla);
