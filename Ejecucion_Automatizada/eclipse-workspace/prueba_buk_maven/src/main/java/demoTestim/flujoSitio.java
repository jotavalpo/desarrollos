...
public class flujoSitio {
	...
	public static String SeleccionarDestino () {
		...
		try {
			...
			msg = FunctionGeneric.clickObjectByXpath("Click en opción 2 adultos", "//*[@id=\'app\']/div/section[1]/div[3]/div/div[3]/ul/li[3]", "click", FunctionGeneric.driver);
			Thread.sleep(1000);
			if (!msg.equals("OK"))
				return msg;
			...
			msg = FunctionGeneric.clickObjectByXpath("Click en opción 2 niños", "//*[@id=\'app\']/div/section[1]/div[3]/div/div[4]/ul/li[3]", "click", FunctionGeneric.driver);
			Thread.sleep(1000);
			if (!msg.equals("OK"))
				return msg;
	...
	public static String filtrarResultados (String valorMaximo) {
		...
		try {
			...
			msg = FunctionGeneric.setTextObjectByXpath("Definir monto máximo", "//*[@id=\'app\']/div/section[2]/div[4]/div/div/div[3]/div[2]/div[2]/input", valorMaximo, "set", FunctionGeneric.driver);
			Thread.sleep(1000);
			if (!msg.equals("OK"))
				return msg;
	...
	public static String completarDatosCheckout (String nombre, String email, String seguroSocial, String telefono, String codPromocion) {
		...
		try {
			...
			msg = FunctionGeneric.setTextObjectByXpath("Ingresar número seguro social (Social Security Number)", "//*[@id=\'app\']/div/div[2]/section[1]/div[3]/div[1]/form/div[3]/input", seguroSocial, "clean", FunctionGeneric.driver);
			Thread.sleep(1000);
			if (!msg.equals("OK"))
				return msg;
			
			msg = FunctionGeneric.setTextObjectByXpath("Ingresar número seguro social (Social Security Number)", "//*[@id=\'app\']/div/div[2]/section[1]/div[3]/div[1]/form/div[3]/input", seguroSocial, "set", FunctionGeneric.driver);
			Thread.sleep(1000);
			if (!msg.equals("OK"))
				return msg;
			
			msg = FunctionGeneric.setTextObjectByXpath("Ingresar teléfono (Phone Number)", "//*[@id=\'app\']/div/div[2]/section[1]/div[3]/div[1]/form/div[4]/input", telefono, "clean", FunctionGeneric.driver);
			Thread.sleep(1000);
			if (!msg.equals("OK"))
				return msg;
			
			msg = FunctionGeneric.setTextObjectByXpath("Ingresar teléfono (Phone Number)", "//*[@id=\'app\']/div/div[2]/section[1]/div[3]/div[1]/form/div[4]/input", telefono, "set", FunctionGeneric.driver);
			Thread.sleep(1000);
			if (!msg.equals("OK"))
				return msg;
			...
			msg = FunctionGeneric.setTextObjectByXpath("Ingresar código descuento (I have a promo code)", "//*[@id=\'app\']/div/div[2]/section[1]/div[3]/div[2]/div[4]/div[1]/div/input", codPromocion, "clean", FunctionGeneric.driver);
			Thread.sleep(1000);
			if (!msg.equals("OK"))
				return msg;
			
			msg = FunctionGeneric.setTextObjectByXpath("Ingresar código descuento (I have a promo code)", "//*[@id=\'app\']/div/div[2]/section[1]/div[3]/div[2]/div[4]/div[1]/div/input", codPromocion, "set", FunctionGeneric.driver);
			Thread.sleep(1000);
			if (!msg.equals("OK"))
				return msg;
			
			msg = FunctionGeneric.clickObjectByXpath("Click en botón APPLY", "//*[@id=\'app\']/div/div[2]/section[1]/div[3]/div[2]/div[4]/div[2]/button", "click", FunctionGeneric.driver);
			Thread.sleep(2000);
			if (!msg.equals("OK"))
				return msg;
			
			msg = FunctionGeneric.clickObjectByXpath("Click en Acepto términos y condiciones (I agree to the terms and conditions)", "//*[@id=\'app\']/div/div[2]/section[1]/div[3]/div[2]/div[5]/div/label/div", "click", FunctionGeneric.driver);
			Thread.sleep(1000);
			if (!msg.equals("OK"))
				return msg;
			
			msg = FunctionGeneric.clickObjectByXpath("Click en botón PAY NOW", "//*[@id=\"app\"]/div/div[2]/section[1]/div[3]/div[2]/div[7]/div/button", "click", FunctionGeneric.driver);
			Thread.sleep(2000);
			if (!msg.equals("OK"))
				return msg;
	...
	public static String IniciarSesion (String usuario, String password) {
		...
		try {
			...
			msg = FunctionGeneric.setTextObjectByXpath("Ingresar contraseña (Password)", "//*[@id=\'login\']/div[2]/input", password, "clean", FunctionGeneric.driver);
			Thread.sleep(1000);
			if (!msg.equals("OK"))
				return msg;
			
			msg = FunctionGeneric.setTextObjectByXpath("Ingresar contraseña (Password)", "//*[@id=\'login\']/div[2]/input", password, "set", FunctionGeneric.driver);
			Thread.sleep(1000);
			if (!msg.equals("OK"))
				return msg;
						
			msg = FunctionGeneric.clickObjectByXpath("Click en Iniciar Sesión (LOG IN)", "button", "type", "submit", "click", FunctionGeneric.driver);
			Thread.sleep(2000);
			if (!msg.equals("OK"))
				return msg;
			
		} catch (Exception e) {
			msg = "Error al iniciar sesión en el sitio";
		}
